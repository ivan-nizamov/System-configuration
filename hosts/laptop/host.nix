...
{
  # Import the hardware configuration from the standard location
  # This file is generated by `nixos-generate-config` and should not be committed to the repository
